...
available version of each case. Predictions and charts use `RECEIVED_DATE`;
the `company_activity` command uses `DECISION_DATE`. Fiscal Q1 is
October–December. `CASE_STATUS` determines whether a case is
